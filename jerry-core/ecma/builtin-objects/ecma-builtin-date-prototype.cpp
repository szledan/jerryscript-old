...
ecma_builtin_date_prototype_get_time (ecma_value_t this_arg) /**< this argument */
{
  if (ecma_is_value_object (this_arg))
  {
    ...
    if (ecma_object_get_class_name (obj_p) == ECMA_OBJECT_TYPE_DATE)
    {
...
/**
 * Helper macro, converting value that would be returned
 * from a Data.prototype built-in's getter routine (int32_t case)
 */
#define CONV_GETTER_RETVAL_int32_t(value) ecma_int32_to_number (value)

/**
 * Helper macro, converting value that would be returned
 * from a Data.prototype built-in's getter routine (ecma_number_t case)
 */
#define CONV_GETTER_RETVAL_ecma_number_t(value) (value)
 ...
 *         Returned value must be freed with ecma_free_completion_value.
 */
#define DEFINE_GETTER(_ecma_paragraph, _routine_name, _getter_name, _type, _timezone) \
static ecma_completion_value_t \
...
{ \
 ...
 \
  ...
  { \
    /* 3. */ \
    _type time_value = _getter_name (DEFINE_GETTER_ARGUMENT_ ## _timezone (*this_num)); \
 \
    ecma_number_t *ret_num_p = ecma_alloc_number (); \
    *ret_num_p = CONV_GETTER_RETVAL_ ## _type (time_value); \
...
DEFINE_GETTER (ECMA-262 v5 15.9.5.10, full_year, ecma_date_year_from_time, int32_t, local)
DEFINE_GETTER (ECMA-262 v5 15.9.5.11, utc_full_year, ecma_date_year_from_time, int32_t, utc)
DEFINE_GETTER (ECMA-262 v5 15.9.5.12, month, ecma_date_month_from_time, int32_t, local)
DEFINE_GETTER (ECMA-262 v5 15.9.5.13, utc_month, ecma_date_month_from_time, int32_t, utc)
DEFINE_GETTER (ECMA-262 v5 15.9.5.14, date, ecma_date_date_from_time, int32_t, local)
DEFINE_GETTER (ECMA-262 v5 15.9.5.15, utc_date, ecma_date_date_from_time, int32_t, utc)
DEFINE_GETTER (ECMA-262 v5 15.9.5.16, day, ecma_date_week_day, int32_t, local)
DEFINE_GETTER (ECMA-262 v5 15.9.5.17, utc_day, ecma_date_week_day, int32_t, utc)
DEFINE_GETTER (ECMA-262 v5 15.9.5.18, hours, ecma_date_hour_from_time, ecma_number_t, local)
DEFINE_GETTER (ECMA-262 v5 15.9.5.19, utc_hours, ecma_date_hour_from_time, ecma_number_t, utc)
DEFINE_GETTER (ECMA-262 v5 15.9.5.20, minutes, ecma_date_min_from_time, ecma_number_t, local)
DEFINE_GETTER (ECMA-262 v5 15.9.5.21, utc_minutes, ecma_date_min_from_time, ecma_number_t, utc)
DEFINE_GETTER (ECMA-262 v5 15.9.5.22, seconds, ecma_date_sec_from_time, ecma_number_t, local)
DEFINE_GETTER (ECMA-262 v5 15.9.5.23, utc_seconds, ecma_date_sec_from_time, ecma_number_t, utc)
DEFINE_GETTER (ECMA-262 v5 15.9.5.24, milliseconds, ecma_date_ms_from_time , ecma_number_t, local)
DEFINE_GETTER (ECMA-262 v5 15.9.5.25, utc_milliseconds, ecma_date_ms_from_time , ecma_number_t, utc)

#undef DEFINE_GETTER_ARGUMENT_utc
#undef DEFINE_GETTER_ARGUMENT_local
#undef CONV_GETTER_RETVAL_int32_t
#undef CONV_GETTER_RETVAL_ecma_number_t
#undef DEFINE_GETTER
